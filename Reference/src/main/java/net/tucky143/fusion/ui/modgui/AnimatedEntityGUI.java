...
public class AnimatedEntityGUI extends ModElementGUI<AnimatedEntity> implements GeckolibElement, IBlocklyPanelHolder {
    ...
    @Override protected void initGUI() {
        ...
        whenMobFalls = new ProcedureSelector(this.withEntry("entity/when_falls"), mcreator,
                ...
                Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/damagesource:damagesource"));
        whenMobDies = new ProcedureSelector(this.withEntry("entity/when_dies"), mcreator,
                L10N.t("elementgui.living_entity.event_mob_dies"),
                Dependency.fromString("x:number/y:number/z:number/world:world/entity:entity/sourceentity:entity/immediatesourceentity:entity/damagesource:damagesource"));
    ...
    @Override
    public AggregatedValidationResult validatePage(int page) {
        if (page == 0) {
